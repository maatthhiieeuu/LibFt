...
int	main()
{
	...
	printf("\033[1;35m\n-trois = \033[1;32m%d\n\033[1;0m", trois);
	printf("\033[1;35m\n-ptr_un  = \033[1;32m%p\n\033[1;0m", ptr_un);
	printf("\033[1;35m\n-ptr_deux  = \033[1;32m%p\n\033[1;0m", ptr_deux);
	printf("\033[1;35m\n-ptr_trois  = \033[1;32m%p\n\033[1;0m", ptr_trois);


	printf("\033[1;33m\nCréation des noeuds:\n\033[1;0m");


	node1	= ft_lstnew(ptr_un);
	node2	= ft_lstnew(ptr_deux);
	node3	= ft_lstnew(ptr_trois);
	...
	printf("\033[1;33m\nDébut du test de la fonction ft_lstdelone:\n\033[1;0m");


	printf("\033[1;35m\nAffichage de la liste dans son état initial:\033[1;0m\n");
	printf("\033[1;35m\n-NODE1:		\033[1;32m%p\033[1;0m\n", (void *)node1);
	printf("   \033[1;35m->content =	\033[1;32m%d\n\033[1;31m\033[1;0m", (int)(size_t)node1->content);
	printf("   \033[1;35m->next    =	\033[1;32m%p\n\033[1;0m", (void *)node1->next);
	...
	printf("\033[1;33m\nAppel de la fonction ft_lstdelone sur node2.\n\033[1;0m");

	ft_lstdelone(node2, del);

	printf("\033[1;35m\nAffichage de la liste dans son état post ft_lstdelone de node2:\033[1;0m\n");
	printf("\033[1;35m\n-NODE1:		\033[1;32m%p\033[1;0m\n", (void *)node1);
	printf("   \033[1;35m->content =	\033[1;32m%d\n\033[1;31m\033[1;0m", (int)(size_t)node1->content);
	printf("   \033[1;35m->next    =	\033[1;32m%p\n\033[1;0m", (void *)node1->next);

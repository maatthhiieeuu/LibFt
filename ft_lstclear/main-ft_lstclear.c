/* ********************************************************************************************* */
/*                                                                                               */
/*   Project : libft/main-ft_lstclear.c                 ::::::  ::::::    :::::::::              */
/*                                                     +:: ::+ +:: ::+   +:::::::::+             */
/*   By: Matthieu Boegler                             +#:  +#::#+ :#+   +:#      #:+             */
...
int	main()
{
	...
	printf("\033[1;33m\nDébut de la phase d'effacement de la liste :\n\033[1;0m");
	...
	printf("\033[1;33m\nAppel de la fonction d'effacement \"ft_lstclear\" sur la liste :\n\033[1;0m");

	ft_lstclear(&node1, del);

	printf("\033[1;33m\nAffichage de bonne effacement de la liste :\n\033[1;0m");
